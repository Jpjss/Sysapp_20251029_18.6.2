    ...
    <table>
        ...
        <tr>
            ...
            <td>
                ...
                <div class="container">
                    <table id="tabela" border="1">
                        <?php foreach ($valorUltCompra as $vlrUltCompra) { ?>
                            <tr class="coluna">
                                <td style="width: 3px;"><input class="todasVlrUltCompra" type="checkbox" name="data[GlbQuestionarioParametro][vlrUltCompra][]" value="<?php echo $vlrUltCompra["GlbQuestionarioParametroFaixaValorUltCompra"]["cd_parametro_faixa"]; ?>" /></td>
...
<!--            <td>
            ...
            <td>
                ...
                <div class="container">
                    <table id="tabela" border="1">
                        <?php foreach ($dtCadastro as $value) { ?>
                            <tr class="coluna">
                                <td style="width: 3px;"><input class="todasDtCadastro" type="checkbox" name="data[GlbQuestionarioParametro][dtCadastro][]" value="<?php echo $value["GlbQuestionarioParametroFaixaDataCadastro"]["cd_parametro_faixa_d"]; ?>" /></td>
            ...
            <td>
                ...
                <div class="container">
                    <table id="tabela" border="1">
                        <?php foreach ($dtAtualizacao as $value) { ?>
                            <tr class="coluna">
                                <td style="width: 3px;"><input class="todasDtAtualizacao" type="checkbox" name="data[GlbQuestionarioParametro][dtAtualizacao][]" value="<?php echo $value["GlbQuestionarioParametroFaixaDataAtualizacao"]["cd_parametro_faix"]; ?>" /></td>
...
<!--        <tr>
            <td colspan="3">
                <table id="tabelaTitulo" border="1">
                    <tr style="font-weight: bold; ">
                        <td style="width: 3px;"></td>
                        <td>Data do Último Pagamento</td>
                        <td>Qtde</td>
                    </tr>
                </table>
                <div class="container">
                    <table id="tabela" border="1">
        <?php // foreach ($dtUltPagamento as $value) { ?>
                                <tr class="coluna">
                                    <td style="width: 3px;"><input type="checkbox" name="data[GlbQuestionarioParametro][dtUltPagamento][]" value="<?php echo $value["GlbQuestionarioParametroFaixaDtUltPagamento"]["cd_parametro_faixa"]; ?>" /></td>
                                    <td style="width: 150px;"><?php echo $value["GlbQuestionarioParametroFaixaDtUltPagamento"]["ds_parametro_faixa"] ?></td>
                                    <td>0</td>
                                </tr>
        <?php // } ?>
                    </table>
            ...
            <td colspan="2">
                <div class="container3">
                    <table id="tabelas" style="width:620px; border: 0px;" border="1">
                        <tr class="coluna">
                            <td colspan="2">Descrição da Pesquisa: 
                                <?php echo $this->Form->input('ds_parametro_questionario', array('label' => false, "type" => "textarea", "maxlength" => "255", "rows" => 4)); ?></td>
                        </tr>
                        <tr class="coluna">
                        ...
                        <tr class="coluna">
                            <td colspan="2">Tipo de cadastro: 
                                ...
                                echo $this->Form->input('tp_cad', array('options' => $status, 'default' => '4', 'label' => false));
                                ?>
                            </td>
                        </tr>
                    </table>
