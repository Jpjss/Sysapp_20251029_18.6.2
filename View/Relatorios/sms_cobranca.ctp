    ...
    $(document).ready(function() {
        ...
        $('form').submit(function() {
            ...
            if ((diferencaEnvio < 0) || (diferencaEnvio > 31)) {
                $("<div style='text-align: left;'>- A <b>data final</b> deve ser maior do que a <b>data inicial</b>. <br>- O Período de <u><b>ENVIO</b></u> deve ter <b>intervalo máximo de <u>31 dias</u></b>.</div>").dialog();
                return false;
            }
            if ((diferencaRetorno < 0) || (diferencaRetorno > 31)) {
                $("<div tittle='teste' style='text-align: left;'>- A <b>data final</b> deve ser maior do que a <b>data inicial</b>. <br>- O Período de <u><b>RETORNO</b></u> deve ter <b>intervalo máximo de <u>31 dias</u></b>.</div>").dialog();
                return false;
            }
...
<div class="glbQuestionarios index">
    <h2><?php echo __('Relatório SMS Cobrança'); ?></h2>
    <style>
...
<?php } ?>
        ...
        <tr>
            ...
            <td><input name="data[Relatorios][per_ini_retorno]" id="per_ini_retorno" type="text"> a <input name="data[Relatorios][per_fim_retorno]" id="per_fim_retorno" type="text"></td>
        </tr>
        <tr>
            <td><b>Exibir</b></td>
            ...
            <td>
                <table border="0" cellspacing="0" cellpadding="0">
                    <tr style="background-color: #FFF">
                        <td width="22" height="19"><input name="data[Relatorios][tipo_sms]" checked="true"  value="T" type="radio" /></td>
                        <td width="278">Ambos</td>
                    </tr>
                    <tr style="background-color: #FFF">
                        <td><input name="data[Relatorios][tipo_sms]" value="0" type="radio" /></td>
                        <td>Clientes Atrasados</td>
                    </tr>
                    <tr style="background-color: #FFF">
                        <td><input name="data[Relatorios][tipo_sms]" value="1" type="radio" /></td>
                        <td>Clientes Negativados</td>
                    </tr>
                </table>
            </td>
            <td>
