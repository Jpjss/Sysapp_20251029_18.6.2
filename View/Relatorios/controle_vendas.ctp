...
<style>
    ...
    .container5 { border:2px solid #ccc; width:auto; height: 100px; overflow:hidden; } /* div periodo*/
...
<div class="vendasVendedor">
    <h2><?php echo __('Relatório de Controle de Vendas'); ?></h2>
    <div class='mensagem'>
    </div>
    ...
    <table class="tabelaPrincipal">
        <tr>
            ...
            <td>
                ...
                <strong>Filtrar por nome de vendedor:</strong><br><input type="text" name="txt_desc_vendedor" style="width: 380px; text-transform: uppercase;" />
            </td>
        </tr>
