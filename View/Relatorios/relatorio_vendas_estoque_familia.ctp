...
<table id="cabecalhoTabela" width="100%" border="0" cellspacing="0" cellpadding="0" style="text-align: center; border-color:red">
    <tr>
        <td style="font-size: 24px;">Relatório Vendas/Estoque por Familia -  <?php echo $this->Session->read('Conexao.Ativa'); ?><br></td>
    </tr>
    <tr>
...
<br>
  	<input type="button" class="btn btn-primary" id="voltar" value="Voltar" onClick="javascript:navigator_Go('/SysApp/app/webroot/index.php/Relatorios/vendas_estoque_familia')"/>
<br>
<div class="contentRelatorio">
    ...
    ?>
        <tr>
        	<td></td>
            <td><?php echo $value['ds_familia']; ?></td>
