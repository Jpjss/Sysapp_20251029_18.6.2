...
<table id="cabecalhoTabela" width="100%" border="0" cellspacing="0" cellpadding="0" style="text-align: center; border-color:red">
    <tr>
        <td style="font-size: 24px;">Relatório Vendas/Estoque por Marca -  <?php echo $this->Session->read('Conexao.Ativa'); ?><br></td>
    </tr>
    <tr>
...
<br>
  	<input type="button" class="btn btn-primary" id="voltar" value="Voltar" onClick="javascript:navigator_Go('/SysApp/app/webroot/index.php/Relatorios/vendas_estoque_marca')"/>
<br>
<div class="contentRelatorio">
    ...
    ?>
       	<tr>
            ...
            <!--  %Qtde Estoque  -->
            <?php if($chave['total_qtde_estoque_real'] != 0){?>
            <td><?php echo number_format(($value['qtde_estoque_real']/$chave['total_qtde_estoque_real'])*100,2, ',' , '.'); ?></td>
            <?php }else{?>
        ...
        <tr style="text-align: center; background: #32C7FF; border: 0px;">
            ...
            <!--  %Qtde Estoque Filial -->
            <?php if($chave['total_qtde_venda'] != 0){?>
            <td><?php echo number_format(($chave['total_qtde_venda']/$chave['total_qtde_venda'])*100, 2, ',', '.'); ?></td>
            <?php }else{?>
            <td><?php echo number_format(0, 2, ',', '.'); ?></td>
            <?php }?>
        ...
        <tr style="background-color:#BBE42F">
		   	...
		   	<td><?php echo number_format(($totalPercentEstoque/$totalPercentEstoque)*100, 2, ',', '.'); ?></td>
