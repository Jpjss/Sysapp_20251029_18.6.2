...
<script>
    $(document).ready(function() {
        ...
        $("#per_ini_fluxo").mask("99/99/9999");
        $("#per_ini_fluxo").datepicker();
        $("#per_fim_fluxo").mask("99/99/9999");
        $("#per_fim_fluxo").datepicker();
...
<div class="vendasVendedor">
    <h2><?php echo __('Relatório de Recebimento de Parcela por Hora'); ?></h2>
    <div class='mensagem'>
    </div>
	            ...
	            <div>
		            <table id='tabela'>
		              <tr>
			            ...
			            <tr>
				            <td>
				            	<input name="data[Relatorios][per_ini_fluxo]" value="<?php echo date("01/m/Y"/*,strtotime("-1 month")*/) ?>" id="per_ini_fluxo" type="text"><br> a <br></b><input name="data[Relatorios][per_fim_fluxo]" value="<?php echo date("d/m/Y"); ?>" id="per_fim_fluxo" type="text">
				            </td>
			            </tr>
			            <td>
