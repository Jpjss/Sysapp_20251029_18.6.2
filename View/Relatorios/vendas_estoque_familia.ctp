...
<script>
    ...
    (function ($) {
    	    var currentYr = (new Date()).getFullYear(),
    	        ...
    	        dst;
    	    $('#RelatoriosVendasEstoqueFamiliaForm').validate({
    	        rules: {
    	            dt_fi : 'dateITA',
    	            dt_in : 'dateITA',
    	            dt_fi_2 : 'dateITA',
    	    ...
    	    $('#dt_fi').on('onChange', function () {
    	        $('#RelatoriosVendasEstoqueFamiliaForm').valid();
    	    });
    ...
    <style>
        ...
        .container4 { border:2px solid #ccc; width: 210px; height: 110px; overflow-y: auto; overflow-x: hidden; }
...
<div class="vendasEstoqueFamilia">
    <h2><?php echo __('Vendas/Estoque por Familia'); ?></h2>
    <div class='mensagem'>
    </div>
            	...
            	<div>
		            <table id='tabela'>
		              <tr>
			            ...
			            <tr>
				            <td>
			            		<input type="text" name="dt_in" id="dt_in" value="<?php echo date("01/m/Y",strtotime("-1 month")) ?>"/><br> a <br></b><input name="dt_fi" value="<?php echo date("t/m/Y",strtotime("-1 month")); ?>" id="dt_fi" type="text">
				     		</td>
			            </tr>
			            <tr>
			            <td>
			            ...
			            <tr>
				            <td>
			            		<input type="text" name="dt_in_2" id="dt_in_2" value=""/><br> a <br></b><input name="dt_fi_2" value="" id="dt_fi_2" type="text">
				     		</td>
			            </tr>
			            <td>
