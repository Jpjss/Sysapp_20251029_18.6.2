...
<div class="glbQuestionarios index">
    <h2><?php echo __('Relatório Retorno Aniversariantes e Inativos'); ?></h2>
    <table>
        <tr>
        ...
        <table>
            ...
            <table>
                        ...
                        <div class="container3">
                            <table id="tabela" border="1">
                                ...
                                <?php foreach ($pesquisa as $key => $pesquisas) { ?>
                                    <tr>
                                        <td style="width: 13px;"><input type="checkbox" class="todasPesquisas" name="data[Relatorios][pesquisa][]" value="<?php echo $key; ?>" type="checkbox" /></td>
                ...
                <table>
                    ...
                    <tr>
                        <td><input name="data[Relatorios][per_ini_pesquisas]" value="" id="per_ini_pesquisas" type="text"> a <input name="data[Relatorios][per_fim_pesquisas]" value="<?php echo date("d/m/Y"); ?>" id="per_fim_pesquisas" type="text"></td>
                    </tr>
                    <tr>
