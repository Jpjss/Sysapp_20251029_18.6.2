...
<table id="cabecalhoTabela" width="100%" border="0" cellspacing="0" cellpadding="0" style="text-align: center; border-color:red">
    <tr>
        <td style="font-size: 24px;">Relatório de Fluxo de Recebimento de Parcela por Hora<br></td>
    </tr>
    <tr>
...
<div class="contentRelatorio">
  	<input type="button" class="btn btn-primary" id="voltar" value="Voltar" onClick="javascript:navigator_Go('/SysApp/app/webroot/index.php/Relatorios/fluxo_recebimento_parcela_hora')"/>
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="text-align: center;">
        <tr style="text-align: center; background: #59a6d6; border: 0px;">
            <td></td>
            <td>Hor&aacute;rio de Recebimento</td>
            <td>Quantidade</td>
        ...
        <tr>
            <td>
        		<?php echo utf8_encode($value['nm_fant']); ?>
        	</td>
        	<td>
        		<?php echo utf8_encode($value['horario_recebimento'])." horas"; ?>
        	</td>
        	<td>
        		<?php echo number_format($value['quantidade']); ?>
        	</td>
        	<td>
        		<?php echo number_format($value['valor_recebido'], 2, ',', '.'); ?>
        	</td>
        	<td>
        		<?php echo number_format($value['valor_medio'], 2, ',', '.'); ?>
        	</td>
        	<td>
        		<?php echo utf8_encode($value['nm_fant']); ?>
        	</td>
        ...
        <tr style="background-color: #32C7FF;">
        	...
        	<td></td>
        	<td>
        		<?php echo $chave['total_quantidade']; ?>
        	</td>
        	<td>
        		<?php echo number_format($chave['total_valor_recebido'], 2, ',', '.'); ?>
        	</td>
        	<td>
        		<?php echo number_format($chave['total_valor_recebido']/$chave['total_quantidade'], 2, ',', '.'); ?>
        	</td>
        	<td>
        		<?php echo utf8_encode($value['nm_fant']); ?>
        	</td>
        ...
        <tr style="background-color:#BBE42F">
        	<td>Total Geral :</td>
        	<td></td>
        	<td><?php echo number_format($totalGeralQuantidade, 0, ',', '.');?> </td>
        	<td><?php echo number_format($totalGeralVlrRecebido, 2, ',', '.');?></td>
        	<td><?php echo number_format(($totalGeralVlrRecebido/$totalGeralQuantidade), 2, ',', '.');?></td>
        	<td></td>
        </tr>
        <?php 
        }
