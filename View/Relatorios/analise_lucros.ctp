...
<div class="analiseLucros">
    <h2><?php echo __('Relatório de An&aacute;lise de Lucros'); ?></h2>
    <div class='mensagem'>
    </div>
    ...
    <table class="tabelaPrincipal">
        <tr>
            ...
            <td colspan="2"><b>Contas de Despesas</b><br>
                <div class="container3">
                    <table id="tabela">
                        <tr>
                            <td style="width: 13px;"><input type="checkbox" id="marcaTodasDespesas" value="" /></td>
                            <td>TODAS AS CONTAS DE DESPESAS</td>
                        </tr>
                        <?php foreach ($contas as $conta) { ?>
                            <tr>
                                <td>
                                	<input type="checkbox" class="despesas" name="data[Relatorios][despesa][]" value="<?php echo $conta["Despesa"]["cd_conta"]; ?>" />
                                </td>
                                <td><?php echo utf8_encode($conta["Despesa"]["ds_conta"]); ?></td>
                            </tr>
                        <?php } ?>
                    </table>
                </div>  
