...
<div class="glbQuestionarios index">
    <h2><?php echo __('Relatório de envio de SMS'); ?></h2>
    <style>
    ...
    <table width="397" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            <td><b>Periodo de Envio de SMS</b></td>
            <td></td>
        ...
        <tr>
            ...
            <td></td>
        <!--<td><input name="data[Relatorios][per_ini_retorno]" type="text"> a <input name="data[Relatorios][per_fim_retorno]" type="text"></td>-->
        </tr>
        <tr>
            <td><b>Exibir</b></td>
        ...
        <tr>
            ...
            <td>
                <table style="width: 200px;" border="0" cellspacing="0" cellpadding="0">
                    <tr style="background-color: #FFF">
                        <td><?php echo $this->Html->image('iconPdf.jpg', array('alt' => 'Ativo',"width" => "30px")); ?></td>
                        <td><?php echo $this->Html->image('iconExcel.jpg', array('alt' => 'Ativo',"width" => "30px")); ?></td>
                    </tr>
                    <tr style="background-color: #FFF">
