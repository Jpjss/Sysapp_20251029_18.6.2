...
<div class="glbQuestionarioParametroFaixaValorMedioCompras form">
    ...
    <fieldset>
        <legend><?php echo __('Editar Filtro Valor Médio de Compra'); ?></legend>
        <?php
        echo $this->Form->input('cd_parametro_faixa_valor_medio_compra', array('value' => $this->data['GlbQuestionarioParametroFaixaValorMedioCompra']['cd_parametro_fai']));
        echo $this->Form->input('ds_parametro_faixa_valor_medio_compra', array("label"=>"Descrição:", 'value' => $this->data['GlbQuestionarioParametroFaixaValorMedioCompra']['ds_parametro_fai']));
        echo $this->Form->input('valor_inicial', array("label"=>"Valor Inicial:","type"=>"text", "onpaste" => "return false;", 'value' => $this->Formatacao->precisao($this->data['GlbQuestionarioParametroFaixaValorMedioCompra']['valor_inicial'], 2)));
        echo $this->Form->input('valor_final', array("label"=>"Valor Final:","type"=>"text", "onpaste" => "return false;", 'value' => $this->Formatacao->precisao($this->data['GlbQuestionarioParametroFaixaValorMedioCompra']['valor_final'], 2)));
        ?>
    </fieldset>
    <table>
        <tr>
