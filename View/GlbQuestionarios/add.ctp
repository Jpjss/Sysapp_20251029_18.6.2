...
<div class="glbQuestionarios form">
    ...
    <fieldset>
        ...
        <table>
            <tr>
                <td><?php echo $this->Form->input('dt_vigencia_ini', array("label" => "Data de Inicio:", "type" => "text", 'value' => $data . " " . $hora, "div" => false)); ?></td>
                <td><?php echo $this->Form->input('dt_vigencia_fim', array("label" => "Data do Fim:", "type" => "text", 'value' => $data . " " . $hora, "div" => false)); ?></td>
            </tr>
