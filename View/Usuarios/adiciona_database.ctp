...
function mudar(){
    ...
    $(document).ready(function() {
		...
		$('#enviar').click(function(){
			...
			$.ajax({
			    type: "POST",
			    url: CbunnyObj.APP_PATH + 'Usuarios/adiciona_database',
			    data: {
			    ...
			    success: function(result){
				    if(result.substring(0,1) == "1"){
	 					$('.mensagem').html("<div class='alert alert-success fade in' role='alert' size='2'><button type='button' class='close' data-dismiss='alert' aria-label='Fechar'><span aria-hidden='true'>&times;</span></button><strong>Banco de dados adicionado com sucesso !</strong></div>");
...
<div class="painelAdmin">
    <h2><?php echo __(utf8_encode('Cadastrar Novo Banco de Dados ')); ?></h2>

    <?php echo $this->Form->create('Database', array('name' => "DatabaseAdicionaDatabaseForm")); ?>
		<!-- Text input-->
		...
		<div class="container">
			<div class="form-group">
			  ...
			  <label class="col-md-5 control-label" for="nome_empresa"><?php echo utf8_encode('Nome da Empresa');?></label>  
				<div class="col-md-4">
			     <input type="hidden" id="cd_empresa" name="cd_empresa" class="form-control input-md" value="<?php echo $cd_empresa[0][0]['cd_empresa']; ?>" >
	  			   <br/>
				   <input type="text" id="nome_empresa" name="nome_empresa" class="form-control input-md" value="">
				   <br/>
				   
				    <label class="col-sd-6 control-label" for="hostname"><?php echo utf8_encode('Host do Banco');?></label> 
	  			     <input type="text" id="hostname" name="hostname" class="form-control input-md" value="">
	  			    <br/>
	  			    
	 			 	<label class="col-sd-6 control-label" for="nome_banco"><?php echo utf8_encode('Nome do Database');?></label> 
	  			     <input type="text" id="nome_banco" name="nome_banco" class="form-control input-md" value="" >
	  			     <br/>
	  			     
	  			    <label class="col-sd-6 control-label" for="usuario_banco"><?php echo utf8_encode('Usu�rio');?></label> 
	  			    	<input type="text" id="usuario_banco" name="usuario_banco" class="form-control input-md" value="">
	  			     	<br/>
	  			     	
						<label class="col-sd-6 control-label" for="senha_banco"><?php echo utf8_encode('Senha');?></label> 
						   <div class="input-group">
						      <input type="password" class="form-control input-md" id="senha_banco" name="senha_banco" value="">
	  			    ...
	  			    <label class="col-sd-6 control-label" for="porta_banco"><?php echo utf8_encode('Porta');?></label> 
	  			    	<input type="text" id="porta_banco" name="porta_banco" class="form-control input-md" value="">
	  			     	<br/>	  			     	
