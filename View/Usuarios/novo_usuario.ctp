            ...
            $.ajax({
                ...
                success: function (result) {
                    if (result.substring(0, 1) == "1") {
                        $('.mensagem').html("<div class='alert alert-success fade in' role='alert' size='2'><button type='button' class='close' data-dismiss='alert' aria-label='Fechar'><span aria-hidden='true'>&times;</span></button><strong>Cadastro efetuado com sucesso !</strong></div>");
                        $(".mensagem").fadeTo(3000, 500).slideUp(500, function () {
                            $(".mensagem").alert('close');
                        });
                        $('#UsuariosNovoUsuarioForm').each(function () {
                            this.reset();
                        });
                    } else {
...
<div class="painelAdmin">
    <h2><?php echo __(utf8_encode('Cadastro de Novo Usu&aacute;rio ')); ?></h2>
    ...
    <div class="container">
        <div class="form-group">
            <label class="col-md-5 control-label" for="nome_usuario"><?php echo utf8_encode('Primeiro nome do usu&aacute;rio'); ?></label>  
            <div class="col-md-4">
                <input type="hidden" id="cd_usuario" name="cd_usuario" class="form-control input-md" value="<?php echo $cd_usuario; ?>" >
                <br/>
                <input type="text" id="nome_usuario" name="nome_usuario" class="form-control input-md" value="">
                <br/>
                <label class="col-sd-6 control-label" for="cd_usu_erp"><?php echo utf8_encode('Codigo Usu&aacute;rio ERP'); ?></label>  
                <input type="text" id="cd_usu_erp" name="cd_usu_erp" class="form-control input-md" value="">
                <br/>
                <label class="col-sd-6 control-label" for="login_usuario"><?php echo utf8_encode('E-mail ( Login )'); ?></label> 
                <input type="text" id="login_usuario" name="login_usuario" class="form-control input-md" value="">
                <br/>
                <label class="col-sd-6 control-label" for="senha_usuario"><?php echo utf8_encode('Digite sua senha'); ?></label> 
                <input type="password" id="senha_usuario" name="senha_usuario" class="form-control input-md" value="" >
                <br/>
                <label class="col-sd-6 control-label" for="prox_senha_usuario_confirm"><?php echo utf8_encode('Confirme sua senha'); ?></label> 
                    ...
                    <table id="tabela">
                        ...
                        foreach ($infoEmpresas as $chave) {
                            foreach ($chave as $value) {
                                ...
                                <tr>
                                    <td>
                                        <input type="checkbox" class="empresas" name="data[Relatorios][empresa][]" value="<?php echo $value['cd_empresa']; ?>" />
                                    </td>
                    ...
                    <table id="tabela">
                        ...
                        foreach ($relatorios as $chave) {
                            foreach ($chave as $value) {
                                ...
                                <tr>
                                    <td>
                                        <input type="checkbox" class="relatorios" name="data[Relatorios][]" value="<?php echo $value['cd_interface']; ?>" />
                                    </td>
