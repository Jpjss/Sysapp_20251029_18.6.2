...
<div style="margin-bottom: 30px;">
    <h1 style="font-size: 32px; font-weight: 600; margin-bottom: 8px;">📊 Relatórios</h1>
    <p style="color: #94a3b8; font-size: 16px;">Selecione um relatório para visualizar análises detalhadas e gerar exportações</p>
</div>
